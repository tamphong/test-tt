 ...
 * @Createdate Tue, 28 Jul 2015 16:30:44 GMT
 */
...
$global_config['cookie_prefix']='nv3c_Oq11g';
...
$global_config['ftp_user_pass']='BXWCu5VfgQM9vP6Ol5ruqQV1gruVX4EDPbz-jpea7qk,';
...
$global_config['session_prefix']='nv3s_Vs01wy';
...
$global_config['allowed_html_tags']=array('embed','object','param','a','b','blockquote','br','caption','col','colgroup','div','em','h1','h2','h3','h4','h5','h6','hr','i','img','li','p','span','strong','sub','sup','table','tbody','td','th','tr','u','ul','ol','iframe','figure','figcaption','video','source','track','code','pre');
...
$rewrite_keys=array(0=>'#"(/test-tt/)index.php\\?language=([a-z-]+)\\&[amp;]*nv=page\\&[amp;]*op=([a-zA-Z0-9-]+).html"#', 1=>'#"(/test-tt/)index.php\\?language=([a-z-]+)\\&[amp;]*nv=news\\&[amp;]*q\\=([^"]+)"#', 2=>'#"(/test-tt/)index.php\\?language=([a-z-]+)\\&[amp;]*nv=news\\&[amp;]*op=search\\&[amp;]*q\\=([^"]+)"#', 3=>'#"(/test-tt/)index.php\\?language=([a-z-]+)\\&[amp;]*nv=news\\&[amp;]*op=tag/([^"]+)"#', 4=>'#"(/test-tt/)index.php\\?language=([a-z-]+)\\&[amp;]*nv=news\\&[amp;]*op=([a-zA-Z0-9-/]+).html"#', 5=>'#"(/test-tt/)index.php\\?language=([a-z-]+)\\&[amp;]*nv=news\\&[amp;]*op=([a-zA-Z0-9-/]+)"#', 6=>'#"(/test-tt/)index.php\\?language=([a-z-]+)\\&[amp;]*nv=news/([a-zA-Z0-9-/]+)"#', 7=>'#"(/test-tt/)index.php\\?language=([a-z-]+)\\&[amp;]*nv=news"#', 8=>'#"(/test-tt/)index.php\\?language=([a-z-]+)\\&[amp;]*nv=seek\\&[amp;]*q\\=([^"]+)"#', 9=>'#"(/test-tt/)index.php\\?language=([a-z-]+)\\&[amp;]*nv=([a-zA-Z0-9-]+)\\&[amp;]*op=search\\&[amp;]*q\\=([^"]+)"#', 10=>'#"(/test-tt/)index.php\\?language=([a-z-]+)\\&[amp;]*nv=([a-zA-Z0-9-]+)\\&[amp;]*op=tag/([^"]+)"#', 11=>'#"(/test-tt/)index.php\\?language=([a-z-]+)\\&[amp;]*nv=([a-zA-Z0-9-]+)\\&[amp;]*op=([a-zA-Z0-9-/]+).html"#', 12=>'#"(/test-tt/)index.php\\?language=([a-z-]+)\\&[amp;]*nv=([a-zA-Z0-9-]+)\\&[amp;]*op=([a-zA-Z0-9-/]+)"#', 13=>'#"(/test-tt/)index.php\\?language=([a-z-]+)\\&[amp;]*nv=([a-zA-Z0-9-/]+)"#', 14=>'#"(/test-tt/)index.php\\?language=([a-z-]+)"#');
